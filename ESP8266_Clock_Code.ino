...
const char happyFace[] = {  // Character array for happy face emoji
  B00100100,
  B01000010,
  B10000001,
  B10001001,
...
// =======================================================================
const char* ssid     = "YUVI_18";     // SSID of local network
const char* password = "8887821897";   // Password on network
...
void setup() 
{
 ...
 // sendCmdAll(CMD_INTENSITY,10); // Adjust the brightness between 0 and 15
   ...
   printStringWithShift("Hello MUSKI ", 100);
  delay(2500);
...
void getTime()
{
  ...
  while(client.connected() && client.available()) {
    ...
    if (line.startsWith("DATE: ")) {
      date = " Muski today is " + line.substring(6, 17);
